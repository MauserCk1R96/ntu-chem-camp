      ...
      <section id="program" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {homeHighlights.map((item) => (
            <div
              key={item.title}
              className="rounded-3xl border border-white/35 bg-white/[0.06] p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.32),0_18px_60px_rgba(2,6,23,0.38),0_0_28px_rgba(34,211,238,0.16)] backdrop-blur-2xl backdrop-saturate-150"
            >
