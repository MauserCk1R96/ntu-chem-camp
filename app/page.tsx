  ...
  return (
    <main className="relative z-10 min-h-screen text-white">
      ...
      <section id="program" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {homeHighlights.map((item) => (
            <div
              key={item.title}
              className="rounded-3xl border border-white/35 bg-white/[0.09] p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.32),0_18px_60px_rgba(2,6,23,0.38),0_0_28px_rgba(34,211,238,0.16)] backdrop-blur-2xl backdrop-saturate-150"
            >
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="grid gap-8 rounded-3xl border border-cyan-100/45 bg-cyan-100/[0.09] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.34),0_20px_70px_rgba(2,6,23,0.4),0_0_36px_rgba(34,211,238,0.2)] backdrop-blur-2xl backdrop-saturate-150 md:grid-cols-[0.85fr_1.15fr] md:p-10">
